 ...
 * Bearer の経路（AccessTokenGuard と、入口の後で退会したばかりの利用者を引けなかったサービス）と Cookie の経路（リフレッシュの `INVALID_TOKEN`。ログアウトはこの本体を使わない）の両方が使う。
 */
 ...
 *   （制限の種類・発信元・パス。決定・2026-09-12・依頼側。#270・#324。アラートにはしない。要件定義書 4.2「アラート」）。
